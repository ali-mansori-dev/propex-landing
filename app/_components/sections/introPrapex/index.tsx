...
const IntroPrapex = () => {
  ...
  return (
    <section className="w-full py-14 lg:py-20 relative my-16">
      <Container className="!flex-col min-h-[400px] lg:h-[80vh] relative items-center justify-center gap-8 !overflow-visible z-10">
        <TitleBadge title={t("title")} icon={<VideoIcon />} />
        <div className="h-0 g:h-6"></div>
        <IntroVideo />
      </Container>
      <Image
        src={PatternTop}
